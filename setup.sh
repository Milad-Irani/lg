...
docker run --restart always -v /var/data/pgsql:/var/lib/postgresql/data -p 5432:5432 --name lg_postgres --network lg_default -e POSTGRES_PASSWORD=postgres_pass -e POSTGRES_USER=postgres_user -d postgres
